...
sudo rm -rf /mnt/disks/stg_dataset/test_test2
sudo -E python -m main_dino --config=configs/final/mvimgnet/dino_our_filter_clases_imgnet.py --workdir=/mnt/disks/stg_dataset/test_test2

sudo cp -r /mnt/disks/stg_dataset/test_test2 /mnt/disks/stg_dataset/mvimgnet_video_filter
...
sudo rm -rf /mnt/disks/stg_dataset/test_test2
sudo -E python -m main_dino --config=configs/final/mvimgnet/dino_frame_filter.py --workdir=/mnt/disks/stg_dataset/test_test2

sudo cp -r /mnt/disks/stg_dataset/test_test2 /mnt/disks/stg_dataset/mvimgnet_frame_filter
