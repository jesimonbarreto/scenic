...
#tips pretrained
sudo -E python -m knn_main --config=configs/final/co3d/knn_eval_tips_base_b.py --workdir=../test_
sudo -E python -m knn_main --config=configs/final/mvimgnet/knn_eval_tips_base_b.py --workdir=../test_
