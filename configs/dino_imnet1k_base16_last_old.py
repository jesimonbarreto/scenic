...
VARIANT = 'S/14'
_IMAGENET_TRAIN_SIZE = 316536 #40608 #237402 #19320 #377*50 #237402 #40608 #10152 (number of video filtered) * n pairs of each video #1281167
...
def get_config():
  ...
  config.experiment_name = 'video_mvimagenet_lim_classes'
  #config
