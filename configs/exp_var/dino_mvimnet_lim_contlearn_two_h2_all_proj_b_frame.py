...
VARIANT = 'B/16'
_IMAGENET_TRAIN_SIZE = 20412 #40608 #237402 #19320 #377*50 #237402 #40608 #10152 (number of video filtered) * n pairs of each video #1281167
_IMAGENET_TEST_SIZE = 4535
...
def get_config():
  ...
  config.load_weights = 'dino_vitb16'#'dino_vitdeits16'#'dinov2_vit'+version.lower()+'14'
