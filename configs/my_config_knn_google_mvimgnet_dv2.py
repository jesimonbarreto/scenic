...
VARIANT = 'S/14'
_IMAGENET_TRAIN_SIZE = 177823 #1281167 #9469 #1281167
_IMAGENET_TEST_SIZE = 59628
...
def get_config():
  ...
  #WANDB
  config.project = 'Eval_new_mvimgnetest_baselineEQUAL'
  config.experiment_name = 'Eval_Dinov2'
  ...
  config.dataset_configs.batch_size_test = 128
