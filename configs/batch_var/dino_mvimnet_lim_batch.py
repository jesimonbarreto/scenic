...
def get_config():
  ...
  #WANDB
  config.project = 'Experiments_variations_batch'
  config.experiment_name = 'video_mvimagenet_5f_limclasses_batch1024'
  #config
  ...
  config.lr_configs.warmup_steps = config.steps_per_epoch * 2
