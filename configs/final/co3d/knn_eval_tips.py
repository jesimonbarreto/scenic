...
def get_config():
  ...
  #for cifar 10
  config.dataset_configs.dataset = 'imagenet2012' #'co3dtest' #'mvimgnetest' #'co3dtest' #'imagenet2012'
  ...
  config.weight_load = 'tips_b14' #'dinov2_vit'+version.lower()+'14' #'dino_vitb16' #'dinov2_vit'+version.lower()+'14'
  # Learning rate.
  #cosine schedule lr
