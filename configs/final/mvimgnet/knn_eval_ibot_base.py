...
VARIANT = 'B/16'
_IMAGENET_TRAIN_SIZE = 237402 #237402 #20412 #177559 #9469 #1281167
...
def get_config():
  ...
  #WANDB
  config.project = 'exp_rebuttal_ibot'
  config.experiment_name = 'eval_mvimagenet_ibot_base'
  config.extract_train = True
  config.transfer_learning = False

  config.train_two_last_vit= False
  config.int_train_last_layers = 0
  ...
  #for cifar 10
  config.dataset_configs.dataset = 'mvimgnetest' #'mvimgnetest' #'co3dtest' #'imagenet2012'
  ...
  config.dataset_configs.pp_train = (
      ...
      '|resize_small(448, data_key="image")'+
      '|resize_small(448, data_key="image_resized")'+
      '|central_crop(448, data_key="image")'+
      '|central_crop(448, data_key="image_resized")'+
  ...
  config.weight_load = 'ibot_vit_b16' #'tips_b14' #'dinov2_vit'+version.lower()+'14' #'dino_vitb16' #'dinov2_vit'+version.lower()+'14'
