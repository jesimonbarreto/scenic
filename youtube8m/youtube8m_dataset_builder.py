...
class Builder(tfds.core.GeneratorBasedBuilder):
  """DatasetBuilder for youtube8m dataset."""
  ...
  def _split_generators(self, dl_manager: tfds.download.DownloadManager):
    ...
    path = os.path.join('/mnt/disks/dataset/youtube/youtube-8m-videos-frames/frames/')
  ...
  def _generate_examples(self, datapath):
    """Yields examples."""
    for video in tf.io.gfile.listdir(datapath):
      dir_search = os.path.join(datapath, video, 'frames', "*.jpg")
